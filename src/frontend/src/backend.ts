...
export class Backend implements backendInterface {
    ...
    async getProperties(arg0: string | null, arg1: ListingType | null, arg2: PropertyType | null, arg3: bigint | null, arg4: bigint | null, arg5: bigint | null, arg6: bigint | null): Promise<Array<Property>> {
        if (this.processError) {
            try {
                const result = await this.actor.getProperties(to_candid_opt_n24(this._uploadFile, this._downloadFile, arg0), to_candid_opt_n25(this._uploadFile, this._downloadFile, arg1), to_candid_opt_n26(this._uploadFile, this._downloadFile, arg2), to_candid_opt_n27(this._uploadFile, this._downloadFile, arg3), to_candid_opt_n27(this._uploadFile, this._downloadFile, arg4), to_candid_opt_n27(this._uploadFile, this._downloadFile, arg5), to_candid_opt_n27(this._uploadFile, this._downloadFile, arg6));
                return from_candid_vec_n17(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_ListingType_n22(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _ListingType): ListingType {
    return from_candid_variant_n23(_uploadFile, _downloadFile, value);
}
function from_candid_PropertyType_n20(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _PropertyType): PropertyType {
...
function from_candid_record_n19(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        propertyType: from_candid_PropertyType_n20(_uploadFile, _downloadFile, value.propertyType),
...
function to_candid_opt_n25(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: ListingType | null): [] | [_ListingType] {
    return value === null ? candid_none() : candid_some(to_candid_ListingType_n12(_uploadFile, _downloadFile, value));
}
function to_candid_opt_n26(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: PropertyType | null): [] | [_PropertyType] {
